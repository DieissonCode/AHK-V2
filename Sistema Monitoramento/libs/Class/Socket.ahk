...
class winsock {
    ...
    Static WM_SOCKET(sockDesc, lParam, mensagem, hwnd) { ; socket monitor
    ...
    _WSAAsyncSelect(sock_desc, hwnd, mensagem, lEvent) =>
        DllCall("Ws2_32\WSAAsyncSelect", "UInt", sock_desc, "UPtr", hwnd, "UInt", mensagem, "UInt", lEvent)
